 ...
 * When an error occurs in table calculation or interperting, a ReactFragment containing information about the error 
 * is returned, but the message property of Error only accepts a string. An error class which accepts a JSX element 
 * allows for more extensive error messages and expandibility in the future.
 * 
 * 
